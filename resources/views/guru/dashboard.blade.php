    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <section class="col-span-2 bg-white p-6 rounded-lg shadow">
                ...
                <p>Lihat perkembangan kelas yang sedang Anda ajar.</p>
                <div class="mt-4">
            ...
            <section class="bg-white p-6 rounded-lg shadow">
                ...
                <ul class="space-y-2">
                    <li class="text-gray-700">Pengumuman 1: Jadwal ujian tengah semester.</li>
                    <li class="text-gray-700">Pengumuman 2: Jadwal ujian akhir semester.</li>
                </ul>
            </section>
        </div>
    </div>
