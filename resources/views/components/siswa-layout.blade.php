                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/siswa/diskusi" :active="request()->is('/siswa/diskusi')">Diskusi</x-nav-link>
                                <x-nav-link href="/siswa/contact" :active="request()->is('/siswa/contact')">Kontak</x-nav-link>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
