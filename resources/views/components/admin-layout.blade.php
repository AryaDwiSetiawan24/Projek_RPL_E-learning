...
<body class="h-full">
    <div class="min-h-full">
                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-11 w-9" src="{{ url('naga-putih.png') }}" alt="Your Company">
                        </div>
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/admin/edit" :active="request()->is('admin/edit')">Edit Data</x-nav-link>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        <x-mobile-nav-link :href="route('profile.edit')">
                            {{ __('Profile') }}
                        </x-mobile-nav-link>
                        ...
                        <a>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <a href="route('logout')"
                                    onclick="event.preventDefault();
                                        this.closest('form').submit();"
                                    class="block px-4 py-2 text-sm text-gray-100" role="menuitem" tabindex="-1"
                                    id="user-menu-item-2">
                                    {{ __('Log Out') }}
                                </a>
                            </form>
        ...
        <main>
            <div class="mx-auto max-w-7xl pt-6 px-4 pb-6 sm:px-6 lg:px-8">
                {{ $slot }}
            </div>
        </main>
    </div>
